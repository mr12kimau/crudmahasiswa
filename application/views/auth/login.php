                        ...
                        <?= $this->session->flashdata('message'); ?>
                            <form method="POST" action="<?= base_url('auth'); ?>" class="needs-validation" novalidate="">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" value="<?= set_value('email'); ?>" class="form-control" name="email" tabindex="1" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" type="password" value="<?= set_value('nama'); ?>" class="form-control" name="password" tabindex="2" required>
                                    <div class="invalid-feedback">
...
<!-- Template JS File -->
<script src="<?= base_url('assets/') ?>s/scripts.js"></script>
